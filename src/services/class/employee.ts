...
import { USER, USER_BEHAVIOR_ERRORS, USER_STATUS} from "../../utils/constants/user";
...
export class Employee {
    ...
    constructor(data: TRegistrationSchema) {
        ...
        this.companyUic = data.companyUic;
    }
